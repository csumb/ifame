...
document.getElementById("media").disabled=false;
    ...
    function initialize_map() {
      if (GBrowserIsCompatible()) {
		  geoXml = new GGeoXml("http://sep.csumb.edu/ifame/scid/nick/testkml.php");
        map = new GMap2(document.getElementById("map_canvas"));
		map.setMapType(G_HYBRID_MAP);
		map.removeMapType(G_SATELLITE_MAP);
        map.setCenter(new GLatLng(36.2177, -121.6956<?php /*echo $latitude . "," . $longitude;*/ ?>), 9);
		map.setUIToDefault();
		disable();
...
function new_kml(){
	...
	geoXml = new GGeoXml("http://sep.csumb.edu/ifame/scid/nick/testkml.php?boundary=" + boundary + "&area=" + loc_area + "&instr=" + instruments + "&dir=" + img_dir + "&media=" + media + "&rand=" + rnumber + "");
	 map.addOverlay(geoXml);
    ...
    <div id="body">    
      ...
      <p /><p />
		<form name="map_choice" action="post" >
            ...
            <option value="0" selected="selected">Study Area</option>
			<?php
        ...
        <select name="instrument" id="instrument" onchange="update_area();">
            <option value="0" selected="selected">Select Instrument Type</option>
            <option value="0" selected="selected">Show All Instruments</option>
			<?php /*
        ...
        <p /><p />
        Click a <font color="#FF0000">red</font> or <font color="#FFFF00">yellow</font> point to view the media and related data
	</div> 


 <div id="map_canvas" style="width: 700px; height: 500px"></div>
 
 <div id="right_side"><a href="about.php">About SCID</a> <p /> <a href="field_ops.php">Field Ops</a> <p /> <a href="ecoviz.php">EcoViz</a> <p /> 

...
document.getElementById("instrument").disabled=false;
    ...
    function initialize_map() {
      if (GBrowserIsCompatible()) {
		  ...
		  geoXml = new GGeoXml("http://sep.csumb.edu/ifame/scid/nick/testkml.php?boundary=0&area=0&instr=0&dir=lobos&media=1&rand=" + rnumber + "");
...
<div id="top_div">
    ...
    <div id="body">    
      <div id="map_control" class="tundra">
		...
		<form name="map_choice" action="post" >
         ...
         <div dojoType="dijit._Widget" style="display:none;">
            <script type="dojo/method" event="postCreate">
                // create dijit.form.Select as a simple wrapper to dojox.form.DropDownSelect for Dojo < 1.4 if(!dijit.form.Select){ dojo.declare("dijit.form.Select", dojox.form.DropDownSelect, {}); } 
                
            </script>
        </div>
        <select jsId="s3" name="transect" id="transect" style="width: 120px;" dojoType="dijit.form.Select" onchange="update_area();">

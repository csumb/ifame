...
function HomeControl(controlDiv, map) {
  ...
  google.maps.event.addDomListener(controlUI, 'click', function() {
	   fb.start( 'http://sep.csumb.edu/ifame/testing/instructions_east.html', 'width:450px height:450px autoStart:once controlsPos:tr' );
...
<div style="position:fixed; bottom:24px; left:15px; width:207px; height:138px; z-index:4;"><img src="scid_images/scid_logo_1.png" border="0" alt="Shelf Characterization and Image Display" /></div>
  ...
  setTimeout(function() {
   ...
   fb.start( 'instructions_east.html', 'autoStart:once width:450px height:450px controlsPos:tr' );
